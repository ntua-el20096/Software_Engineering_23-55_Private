...
function goToTitleDetails(movie) {
    const queryString = `?title=${encodeURIComponent(movie.title_primaryTitle)}&category=${encodeURIComponent(movie.title_type)}&releaseYear=${encodeURIComponent(movie.title_startYear)}&rating=${encodeURIComponent(movie.avRating)}&votes=${encodeURIComponent(movie.nVotes)}&isAdult=${encodeURIComponent(movie.title_isAdult)}&runtimeMinutes=${encodeURIComponent(movie.title_runtimeMinutes)}&posterUrl=${encodeURIComponent(getPosterUrl(movie.title_posterURL, 'w92'))}`;
...
function goToNameDetails(name) {
    const queryString = `?name=${encodeURIComponent(name.name)}&birthYear=${encodeURIComponent(name.birthYr || 'N/A')}&deathYear=${encodeURIComponent(name.deathYr || 'Present')}&profession=${encodeURIComponent(name.profession || 'N/A')}&posterUrl=${encodeURIComponent(getPosterUrl(name.namePoster, 'w92'))}`;
