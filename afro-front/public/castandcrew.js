    ...
    return fetch(`${baseurl}/name/${nameID}`)
        ...
        .then(data => {
            ...
            return {
                ...
                posterURL: data.nameObject.namePoster.replace('{width_variable}', 'w500') || 'none.png',
            };
        })
        .catch(error => {
...
function updateUI() {
    ...
    for (var i = 0; i < slatestMovies.length; i++) {
        ...
        //τι εχει σε αυτο το image η δωρα?
        //πριν ειχε αυτο:
        //<img class="posterImage" src="${posterURL}" alt=" ">
        // <img src="${getPosterUrl(name.namePoster, 'w185')}" alt="Poster Image" onerror="this.src='none.png'" style="max-height: 250px;"><br><br>
